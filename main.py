...
def client_show(update, context):
    context.bot.send_message(chat_id=update.message.chat_id, text="You are Client")


def view_show(update, context):
    context.bot.send_message(chat_id=update.message.chat_id, text="You are View")
...
client_handler = CommandHandler('client', client_show)
view_handler = CommandHandler('view', view_show)
...
dispatcher.add_handler(client_handler)
